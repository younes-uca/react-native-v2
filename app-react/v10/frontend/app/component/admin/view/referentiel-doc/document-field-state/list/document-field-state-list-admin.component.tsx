...
const List = () => {
    ...
    const [selectedItem, setSelectedItem] = useState<DocumentFieldStateDto>(emptyItem);
    const [rows, setRows] = useState<number>(10);
    const [totalRecords, setTotalRecords] = useState(0);
    const [criteria, setCriteria] = useState(new DocumentFieldStateCriteria());
    const [first, setFirst] = useState(0);
    const toast = useRef<Toast>(null);
    const dt = useRef<DataTable<DocumentFieldStateDto[]>>(null);
    ...
    const fetchItems = (criteria: DocumentFieldStateCriteria) => {
        DocumentFieldStateAdminService.findPaginatedByCriteria(criteria).then(({data}) => {
    ...
    const add = (item: DocumentFieldStateDto) => {
        setItems([...items, item]);
    };
