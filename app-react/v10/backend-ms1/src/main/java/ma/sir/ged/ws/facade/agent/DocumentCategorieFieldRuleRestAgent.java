...
@RestController
@RequestMapping("/api/agent/documentCategorieFieldRule/")
public class DocumentCategorieFieldRuleRestAgent  extends AbstractController<DocumentCategorieFieldRule, DocumentCategorieFieldRuleDto, DocumentCategorieFieldRuleHistory, DocumentCategorieFieldRuleCriteria, DocumentCategorieFieldRuleHistoryCriteria, DocumentCategorieFieldRuleAgentService, DocumentCategorieFieldRuleConverter> {
    ...
    public DocumentCategorieFieldRuleRestAgent (DocumentCategorieFieldRuleAgentService service, DocumentCategorieFieldRuleConverter converter) {
