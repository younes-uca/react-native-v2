...
@RestController
@RequestMapping("/api/agent/documentCategorieField/")
public class DocumentCategorieFieldRestAgent  extends AbstractController<DocumentCategorieField, DocumentCategorieFieldDto, DocumentCategorieFieldHistory, DocumentCategorieFieldCriteria, DocumentCategorieFieldHistoryCriteria, DocumentCategorieFieldAgentService, DocumentCategorieFieldConverter> {
    ...
    public DocumentCategorieFieldRestAgent (DocumentCategorieFieldAgentService service, DocumentCategorieFieldConverter converter) {
