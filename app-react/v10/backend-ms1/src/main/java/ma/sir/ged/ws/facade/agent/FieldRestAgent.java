...
@RestController
@RequestMapping("/api/agent/field/")
public class FieldRestAgent  extends AbstractController<Field, FieldDto, FieldHistory, FieldCriteria, FieldHistoryCriteria, FieldAgentService, FieldConverter> {
    ...
    public FieldRestAgent (FieldAgentService service, FieldConverter converter) {
