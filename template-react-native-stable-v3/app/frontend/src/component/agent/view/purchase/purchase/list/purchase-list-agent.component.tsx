...
import PurchaseAgentCard from "../card/purchase-card-agent.component";


const PurchaseAgentList: React.FC = () =>  {
    ...
    <ScrollView showsVerticalScrollIndicator={false} style={{ paddingHorizontal: 10, backgroundColor: '#e6e8fa' }}>
        ...
        <View style={{ marginBottom: 100 }}>
            {purchases && purchases.length > 0 ? ( purchases.map((purchase) => (
                <PurchaseAgentCard key={purchase.id}
...
export default PurchaseAgentList;
