...
import {PurchaseAgentService} from '../../../../../../controller/service/agent/PurchaseAgentService.service';
import  {PurchaseDto}  from '../../../../../../controller/model/Purchase.model';

import {ClientDto} from '../../../../../../controller/model/Client.model';
import {ClientAgentService} from '../../../../../../controller/service/agent/ClientAgentService.service';
import {ProductDto} from '../../../../../../controller/model/Product.model';
import {ProductAgentService} from '../../../../../../controller/service/agent/ProductAgentService.service';
import {PurchaseItemDto} from '../../../../../../controller/model/PurchaseItem.model';
import {PurchaseItemAgentService} from '../../../../../../controller/service/agent/PurchaseItemAgentService.service';

const PurchaseAgentCreate = () => {
    ...
    const service = new PurchaseAgentService();
    const clientAgentService = new ClientAgentService();
    const productAgentService = new ProductAgentService();
    const purchaseItemAgentService = new PurchaseItemAgentService();
    ...
    useEffect(() => {
        clientAgentService.getList().then(({data}) => setClients(data)).catch(error => console.log(error));

        productAgentService.getList().then(({data}) => setProducts(data)).catch(error => console.log(error));
    }, []);
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#e6e8fa' }} >
        <ScrollView style={{ margin: 20, marginBottom: 80 }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" >
            ...
            <Collapsible collapsed={isPurchaseItemsElementCollapsed}>
                ...
                purchaseItemsElementsCollapsible isPurchaseItemsElementsCollapsed
...
export default PurchaseAgentCreate;
