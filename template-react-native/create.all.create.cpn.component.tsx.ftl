...
return(
    <SafeAreaView style={{ flex: 1, backgroundColor: '#e6e8fa' }} >
        <ScrollView style={{ margin: 20, marginBottom: 80 }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" >
            ...
            <Collapsible collapsed={is${pojo.name}Collapsed}>
                <#list pojo.fields as field>
                    <#if field.simple && !field.notVisibleInCreatePage>
                        <#if  field.large>
                            <CustomInput control={control} name={'${field.name}'} placeholder={'${field.name?cap_first}'} keyboardT="default" />
                        <#elseif field.pureString>
                            <CustomInput control={control} name={'${field.name}'} placeholder={'${field.name?cap_first}'} keyboardT="default" />
                        <#elseif field.id == false>
                            <CustomInput control={control} name={'${field.name}'} placeholder={'${field.name?cap_first}'} keyboardT="numeric" />
                        </#if>
            ...
            <TouchableOpacity onPress={itemCollapsible} style={{ backgroundColor: '#ffd700', padding: 10, borderRadius: 10, marginVertical: 5 }}>
            ...
            <Collapsible collapsed={isItemCollapsed}>
                ...
                <TouchableOpacity onPress={ isEditMode ? handleItemSubmit((data) => { handleUpdateItem(data); }) : handleItemSubmit(handleAddPurchaseItem) } style={{ backgroundColor: '#32cd32', borderRadius: 10, marginBottom: 5, width: '20%', paddingVertical: 10, marginLeft: '80%', marginTop: 10 }} >
