...
const DocumentFieldStateAdminCard = ({ code ,libelle ,style , onPressDelete, onUpdate, onDetails }) =>{
        ...
        <View style={{ flexDirection: 'row', width: '100%' }} >
            ...
            <TouchableOpacity onPress={onDetails} style={{ height: 170, marginHorizontal: 10, borderRadius: 15, marginVertical: 10, elevation: 13, backgroundColor: 'white', width: '95%', flexDirection: 'row', justifyContent: 'space-between' }} >
                ...
                <View style={{ marginLeft: 15, marginVertical: 10 }}>
                    ...
                    <View style={styles.infos}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>- Style: </Text>
                        <Text style={{ fontSize: 16, fontWeight: 'bold' }}>{style}</Text>
                    </View>
...
export default DocumentFieldStateAdminCard;
