...
const DocumentCategorieFieldAdminCard = ({ fieldName ,documentCategorieName ,documentCategorieFieldRuleName , onPressDelete, onUpdate, onDetails }) =>{
            ...
            <TouchableOpacity onPress={onDetails} style={{ height: 170, marginHorizontal: 10, borderRadius: 15, marginVertical: 10, elevation: 13, backgroundColor: 'white', width: '95%', flexDirection: 'row', justifyContent: 'space-between' }} >
                ...
                <View style={{ marginLeft: 15, marginVertical: 10 }}>
                    ...
                    <View style={styles.infos}>
                        ...
                        <Text style={{ fontSize: 14, fontWeight: 'bold' }}>{fieldName}</Text>
                    </View>
                    <View style={styles.infos}>
                    ...
                    <View style={styles.infos}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>- Document categorie field rule: </Text>
                        <Text style={{ fontSize: 14, fontWeight: 'bold' }}>{documentCategorieFieldRuleName}</Text>
                    </View>
...
export default DocumentCategorieFieldAdminCard;
