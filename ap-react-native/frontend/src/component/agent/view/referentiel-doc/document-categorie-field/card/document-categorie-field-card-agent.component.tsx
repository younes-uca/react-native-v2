...
const DocumentCategorieFieldAgentCard = ({ fieldName ,documentCategorieName ,documentCategorieFieldRuleName , onPressDelete, onUpdate, onDetails }) =>{
...
export default DocumentCategorieFieldAgentCard;
